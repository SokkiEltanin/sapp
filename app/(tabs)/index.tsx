...
// ── Sekcje wydzielone do React.memo (perf audit 2026-08) ──────────────────────
// Cały dashboard re-renderuje się przy każdej zmianie dowolnego store'a i przebudowuje
...
const SpendByDaySection = React.memo(function SpendByDaySection(
...
const FixedVariableSection = React.memo(function FixedVariableSection(
...
const YearAgoSection = React.memo(function YearAgoSection(
...
const CalorieBalanceSection = React.memo(function CalorieBalanceSection(
...
const SavingsSection = React.memo(function SavingsSection(
