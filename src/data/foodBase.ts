...
export const FOOD_BASE: BaseFood[] = [
  ...
  { name: 'Kinder Bueno',         kcal: 570, protein: 8,   unit: 'szt',      unitGrams: { szt: 21 } },
  { name: 'Snickers',             kcal: 480, protein: 8,   unit: 'szt',      unitGrams: { szt: 50 } },
  { name: 'Ptasie mleczko',       kcal: 390, protein: 3,   unit: 'szt',      unitGrams: { szt: 15 } },
  { name: 'Michałki',             kcal: 520, protein: 7,   unit: 'szt',      unitGrams: { szt: 12 } },
  { name: 'Krówki',               kcal: 400, protein: 2,   unit: 'szt',      unitGrams: { szt: 7 } },
  { name: 'Prince Polo',          kcal: 540, protein: 6,   unit: 'szt',      unitGrams: { szt: 18 } },
  { name: 'Grześki',              kcal: 505, protein: 6,   unit: 'szt',      unitGrams: { szt: 36 } },
  { name: 'Delicje (biszkopt)',   kcal: 380, protein: 4,   unit: 'szt',      unitGrams: { szt: 13 } },
  { name: 'Sernik',               kcal: 320, protein: 7,   unit: 'porcja',   unitGrams: { porcja: 120 } },
  { name: 'Brownie',              kcal: 420, protein: 5,   unit: 'porcja',   unitGrams: { porcja: 60 } },
  { name: 'Pączek',               kcal: 360, protein: 6,   unit: 'szt',      unitGrams: { szt: 70 } },
  { name: 'Drożdżówka',           kcal: 330, protein: 6,   unit: 'szt',      unitGrams: { szt: 80 } },
  { name: 'Lody na patyku',       kcal: 270, protein: 3,   unit: 'szt',      unitGrams: { szt: 70 } },
  { name: 'Galaretka owocowa',    kcal: 70,  protein: 1.2, unit: 'porcja',   unitGrams: { porcja: 120 } },
  { name: 'Budyń',                kcal: 100, protein: 3,   unit: 'porcja',   unitGrams: { porcja: 140 } },
  { name: 'Kisiel',               kcal: 55,  protein: 0.2, unit: 'porcja',   unitGrams: { porcja: 150 } },
  { name: 'Gofry',                kcal: 290, protein: 6,   unit: 'szt',      unitGrams: { szt: 80 } },
