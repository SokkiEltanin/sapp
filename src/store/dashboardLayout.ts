...
export const SECTION_TITLES: Record<string, string> = {
  ...
  'calorie-balance': 'Bilans kalorii',
  'sleep-chart':    'Sen (7/30 dni)',
  ...
  'insights-web':   'Co na Ciebie wpływa',
...
export const SECTION_DESC: Record<string, string> = {
  ...
  'bank-queue':     'Płatności z banku do zatwierdzenia',
  'calorie-balance':'Ile spaliłeś vs ile zjadłeś — dziś i przez 7 dni',
  'sleep-chart':    'Wykres snu — przełącznik tydzień/miesiąc',
  ...
  'reflections':    'Szybka myśl/refleksja — podpisana i datowana (np. impuls na słodycze)',
  ...
  'correlations':   'Zależności: sen / kroki / nastrój / wydatki',
  'insights-web':   'Powiązania (Pearson): sen · energia · humor · słodycze · praca',
...
export const SECTION_GROUP: Record<string, string> = {
  ...
  'fun-facts': 'Przegląd i statystyki', 'correlations': 'Przegląd i statystyki', 'insights-web': 'Przegląd i statystyki', 'year-ago': 'Przegląd i statystyki',
