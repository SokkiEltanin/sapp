...
export const SECTION_TITLES: Record<string, string> = {
  ...
  'savings-goal':   'Skarbonka (cel oszczędności)',
...
export const SECTION_DESC: Record<string, string> = {
  ...
  'savings-goal':   'Odkładaj na cel — pasek wypełnia się, gdy dorzucasz',
...
export const SECTION_GROUP: Record<string, string> = {
  ...
  'counters-since': 'Nastrój i liczniki', 'gablota-card': 'Nastrój i liczniki', 'savings-goal': 'Finanse',
